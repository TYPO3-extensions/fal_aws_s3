<?php
namespace CORE4\FalAwsS3\Driver;
			...
			function(&$object) use ($identifier, $recursive, $filter) {
				return (
					$object['Key'] !== $identifier
						...
						&& ($filter === \CORE4\FalAwsS3\Driver\AmazonS3Driver::FILTER_ALL
							|| $filter === \CORE4\FalAwsS3\Driver\AmazonS3Driver::FILTER_FOLDERS && \CORE4\FalAwsS3\Driver\AmazonS3Driver::is_dir($object['Key'])
							|| $filter === \CORE4\FalAwsS3\Driver\AmazonS3Driver::FILTER_FILES && !\CORE4\FalAwsS3\Driver\AmazonS3Driver::is_dir($object['Key'])
						)
				);
			}
		);
